...
utilitzarem el criteri __Calinski-Harabasz__ aplicat sobre el nostre conjunt de dades, que mitjançant l'execució de l'algorisme __kmeans__, podrem determinar el valor ___k___ òptim, que correspon al nombre de clústers d'elements semblants. 
